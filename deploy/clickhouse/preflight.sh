...
[ "$(client "SELECT count() FROM system.tables WHERE database = '\''linka_metric'\'' AND name IN ('\''product_outcomes_v2'\'', '\''datalens_outcomes_v1'\'', '\''datalens_outcomes_daily_v1'\'', '\''datalens_tts_operations_daily_v1'\'', '\''datalens_telemetry_quality_daily_v1'\'')")" = "5" ]
[ "$(client "SELECT count() FROM system.tables WHERE database = '\''linka_metric'\'' AND name IN ('\''fundraising_ingest_batches_v1'\'', '\''fundraising_events_v1'\'', '\''datalens_fundraising_v1'\'', '\''fundraising_finance_daily_v1'\'')")" = "4" ]
